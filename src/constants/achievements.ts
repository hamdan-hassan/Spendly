...
export const achievements: Achievement[] = [
  ...
  },
  {
    id: 'early_bird',
    name: 'Early Bird',
    description: 'Log a transaction before 8:00 AM',
  ...
  },
  {
    id: 'frugal_friday',
    name: 'Frugal Friday',
    description: 'Log an expense on a Friday',
  ...
  // NEW ACHIEVEMENTS
  {
    id: 'night_owl',
    name: 'Night Owl',
    description: 'Log an expense between 12 AM and 4 AM',
    icon: 'moon-outline',
    color: '#6366F1',
    requiredValue: 1,
    category: 'milestone',
  },
  {
    ...
    description: 'Log 3 expenses on a weekend',
    icon: 'beer-outline',
    color: '#F43F5E',
    requiredValue: 3,
    category: 'tracking',
  },
  {
    id: 'big_spender',
    name: 'High Roller',
    description: 'Log a single massive expense',
  ...
  },
  {
    id: 'category_king',
    name: 'Category King',
    description: 'Log 10 expenses in the same category',
    icon: 'apps-outline',
    color: '#D946EF',
    requiredValue: 10,
    category: 'tracking',
  },
  {
    id: 'half_century',
    name: 'Half Century',
    description: 'Reach Level 50 (or accumulate 50K XP)',
    icon: 'medal-outline',
    color: '#EAB308',
    requiredValue: 50000,
    category: 'milestone',
